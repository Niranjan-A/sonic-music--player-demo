...
const songs = [
    ...
    },
    {
        ...
        artist: 'DMNDS & Strange Fruits Music'
    },
    {
        name: 'workout_3',
        displayName: 'Industry Baby',
        artist: 'Lil Nax X, Jack Harlow'
    },
    {
        name: 'workout_4',
    ...
    {
        name: 'workout_6',
        displayName: 'See Me Fall',
        artist: 'Ro Ransom ft. Kensei Abbot'
    },
    {
        name: 'workout_7',
    ...
    {
        name: 'workout_8',
        displayName: ' GOSPEL (Brawl Drill Remix)',
        artist: 'Super Smash Bros'
    }
];
//Check if playing
let isPlaying = false; 
