...
const songs = [
    ...
    {
        name: 'solace_3',
        displayName: 'Fly Me To The Moon (Cover)',
        artist: 'The Macarons Project'
    },
    {
        name: 'solace_4',
        displayName: 'Trampoline (Cover)',
        artist: 'Highland Peak'
    },
    {
        name: 'solace_5',
        displayName: "When the party's over",
